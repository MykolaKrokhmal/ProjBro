...
public class For23 {
    public static void main(String[] args) {
        ...
        System.out.println("----------------------------------------------------------------------------------------");
        System.out.println("Enter X and N (>0). Find 1 - (X^2)/2! + (X^4)/4! - .. + ((-1)^N-1)*(X^(2*N))/((2*N)!).");
        System.out.println("----------------------------------------------------------------------------------------");
        ...
        if (nValue <= 0) {
            ...
            double sumValue       = 1;
            double valuePower     = 1;
            for (int i = 2; i <= 2 * nValue; i += 2){
                valuePower     *= (-1) * xValue * xValue;
                factorialValue *= (i - 1) * i;
                sumValue       += valuePower / factorialValue;
            }
            System.out.println("Cos(X) = 1 + (X^1)/1! + (X^2)/2! + (X^3)/3! + .. + (X^N)/N! is " + sumValue);
            System.out.println(Math.cos(xValue));
        }
