...
public class Arr21 {
    public static void main(String[] args) {
        ...
        if (KValue <= 0) System.out.println("Incorrect enter. It must be 1 <= K.");
            ...
            double averageValue = sumValue / (LValue - KValue + 1.0);

            String result = String.format("Average value of elements of range from %d to %d is %f", KValue, LValue, averageValue);
